...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2023 at 03:38 PM
...
INSERT INTO `items` (`item_id`, `order_id`, `user_id`, `product_id`, `seller_id`, `qty`, `size`) VALUES
(99, 95, 45, 4, 8, 1, 'LARGE'),
(100, 96, 45, 9, 8, 1, 'SMALL'),
(101, 97, 45, 5, 39, 1, 'MEDIUM');
...
INSERT INTO `products` (`id`, `user_id`, `name`, `price`, `image`, `item_brand`, `quantity`, `description`, `sales`, `date_added`) VALUES
...
(36, 48, 'Samsung Galaxy ', '2500', '1701783567-Iphonethis.png', 'Gadget', 500, 'asdadasdasd', 0, '2023-12-05 14:00:34');
...
INSERT INTO `user_form` (`id`, `fullname`, `email`, `username`, `password`, `checkout_pass`, `phonenumber`, `address`, `address2`, `landmark`, `city`, `province`, `zip`, `dateofbirth`, `gender`, `image`, `shopname`, `shopdesc`, `vkey`, `verify_token`, `verified`, `register_date`, `id_pic`, `has_verified_badge`, `is_banned`, `number_verified`) VALUES
...
(45, 'Earl Cartney N. Centino', 'rakunn777@gmail.com', 'Ran1020', '81dc9bdb52d04dc20036dbd8313ed055', '0ae84817365fa50ae008311381d052a0', '09682601128', 'San Jose, Rainbow Village', 'Taboan, Tacloban', 'Near Madisson Park', 'Tacloban City', 'Leyte', '6500', '2023-11-13', '', 'profile_2094043675.png', 'user', '', 'e92f29283cf4e4c42e7a14286efdb22e', '7dea3ba66d3dfe004c6aba00a4415f83NetGosyo', 1, '2023-12-05 13:35:24', NULL, NULL, 0, 1),
