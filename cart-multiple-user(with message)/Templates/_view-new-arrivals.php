    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <?php
                    ...
                    WHERE user_form.is_banned = 0  AND products.sales = 0 ") or die('query failed!');
            ...
            <div class="col mb-5">
                <div class="card h-100" style="box-shadow: 1px 1px 5px #333333;">
                    ...
                    <div class="badge bg-danger text-white position-absolute" style="top: 0.5rem; right: 0.5rem">New!
                    </div>
