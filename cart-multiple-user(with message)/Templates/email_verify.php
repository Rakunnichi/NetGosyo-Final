...
<div class="container">
  <div class="alert alert-success" role="alert">
    <div>
      <i class="fas fa-check-circle icon-check-circle mb-3"></i>
      <h4 class="alert-heading">Your Email has been Verified!</h4>
      <p class="mb-4">Congratulations! You can now Login to Your Account!</p>
