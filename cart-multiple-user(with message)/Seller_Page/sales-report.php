...
for ($month = 1; $month <= $currentMonth; $month++) {
    $orders_query = mysqli_query($conn, "SELECT * FROM orders WHERE seller_id = '$user_id' AND MONTH(order_added) = $month AND status = 'Received'");
    $orders = array();
    $totalMonthSales = 0;
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        <h2 class="text-center">Sales Report for the Year</h2>
        <br>
        <div>
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        ...
                        ticks: {
                            // You can customize tick options here
                            beginAtZero: true,
                            callback: function(value, index, values) {
                                return '$' + value; // Customize the format of Y-axis ticks
                            },
                        },
                    },
                ...
                animation: {
                    onComplete: function() {
                        // Calculate and display total sales and total predicted sales
                        let totalSales = monthDataTotal.reduce((acc, current) => acc + current, 0);
