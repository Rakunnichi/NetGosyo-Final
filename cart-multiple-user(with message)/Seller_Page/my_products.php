        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">My Products</li>
                </ol>
                <h6 class="font-weight-bolder text-white mb-0">My Products</h6>
            </nav>
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <a href="add_product.php"><button type="button" class="btn button-newprod btn-sm">Add A New Product</button></a>
            </div>
            </div>
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <a href="update_product.php?id=<?php echo $fetch_product['id'];?>"><button type="button" class="btn button-update btn-sm">Update</button></a>
                        ...
                        <input type="hidden" class="delete_id_value" value="<?php echo $fetch_product['id'];?>" >
                        <a href="javascript:" class="delete_btn_ajax btn button-remove btn-sm" >Delete</a>
