  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">Seller Profile</li>
                </ol>
                <h6 class="font-weight-bolder text-white mb-0">Seller Profile</h6>
            </nav>
    ...
    <div class="container-fluid px-2 px-md-4">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('https://images.unsplash.com/photo-1531512073830-ba890ca4eba2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80');">
        <span class="mask  color-orange-bg  opacity-6"></span>
      </div>
        ...
        <div class="row gx-4 mb-2">
          <div class="col-auto">
            ...
            <?php if($image == null){ ?>
              ...
              <img src="../assets/shop-image-default.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
              ...
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    ...
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp; (+63) <?php echo $phonenumber; ?></li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong> &nbsp; <?php echo $email; ?></li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Address:</strong> &nbsp; <?php echo $address; ?>, <?php echo $city; ?>, <?php echo $province; ?> </li>
                  </ul>
                </div>
              </div>
            </div>
