                                    ...
                                    <div class="mt-2 pt-3 border-top">
                                        <div class="convo" id="convo">
                                            ...
                                            <div class="<?= $row['from_id'] != $user_id ? 'sender' : 'receiver' ?>"
                                                ...
                                                <?php } ?>
                                                <br>
                                                <small><span style="font-size: .5em; opacity: 80%;"><?= $row['message_added'] ?></span></small>
                                            </div>
                                            <?php } ?>
                                        </div>
                                    </div>
