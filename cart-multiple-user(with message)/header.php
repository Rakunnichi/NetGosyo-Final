...
if (isset($_POST['add_to_cart'])) {
  ...
  if (mysqli_num_rows($select_cart) > 0) {
    ...
    mysqli_query($conn, "INSERT INTO `cart` (user_id, product_id, seller_id, name, price, image, quantity, size) VALUES
        ('$user_id', '$product_id', '$seller_id', '$product_name', '$product_price', '$product_image', '$product_quantity', '$product_size')") or die('query failed');
