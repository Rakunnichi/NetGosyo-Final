<section class="py-5" id="view_top_products">
    <div class="text-center">
        ...
        <h4 class="font-rubik font-size-50"><b>Men`s Bag & Accesories</b></h4>
    </div>
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            <?php
                    ...
                    WHERE user_form.is_banned = 0 AND where item_brand = 'Men-Bag-Accesories' ORDER BY products.sales DESC") or die('query failed!');
